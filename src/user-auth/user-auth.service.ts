...
import {User, UserInterface,Patient,PatientInterface } from 'database/entities';
...
export class UserAuthService {
    ...
    async addPatient(user: User, addPatient: PatientInterface): Promise<Patient> {
        addPatient.user = user;
        return this.PatientRepository.save(addPatient);
    }

    async getPatient(queryDto: Query): Promise<Patient[]> {
    ...
    async getUserPatients(id: number): Promise<User> {
